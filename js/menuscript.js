...
if(document.getElementById("goodies-nav")!= null){
  ReactDOM.render(
...
if(document.getElementById("pizza-sets")!= null){
  ReactDOM.render(
...
if(document.getElementById("today-pizza")!= null){
  ReactDOM.render(
...
if(document.getElementById("social-nav")!= null){
  ReactDOM.render(
